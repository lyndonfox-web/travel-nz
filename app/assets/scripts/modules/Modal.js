class Modal {
  constructor() {
    ...
    //todo this.openModalButton = document.querySelectorAll('.open-modal');
    this.events();
  }

  events() {
    // listen for open click
    //todo this.openModalButton.forEach((el) =>
    //todo   el.addEventListener('click', (e) => this.openTheModal(e)));
  ...
  //todo   this.modal.classList.add('modal--is-visible');
  //todo }
